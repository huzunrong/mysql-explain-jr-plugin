package com.example.plugin.mysql.common;
...
import static com.example.plugin.mysql.common.Constant.CUSTOM_PROPERTIES_FILENAME;
...
import static com.example.plugin.mysql.util.StringUtils.putSplit;
...
public final class Config {
    ...
    static {
        String propertiesFile = System.getProperty(CUSTOM_PROPERTIES_FILENAME);
